...
public class LogicaPersonaje1 : MonoBehaviour
{
    ...
    private float dañoArmaEnemigo = 2f;
    void ConfiguraRb()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (anim.GetBool("Espada") == false && anim.GetBool("escudo") == false)
            {
                anim.Play("Impacto1");
            }
            else if (anim.GetBool("Espada") == true && anim.GetBool("escudo")==false)
            {
                anim.Play("Impacto2");
            }
            else if (anim.GetBool("Espada") == false && anim.GetBool("escudo") == true)
            {
                anim.Play("Impacto3");
            }
